...
gulp.task('javascript', function (cb) {
    pump([
            gulp.src([
                ...
                'assets/components/foundation-sites/dist/js/plugins/foundation.foundation.min.js',
                'assets/components/foundation-sites/dist/js/plugins/foundation.util.mediaQuery.js',
